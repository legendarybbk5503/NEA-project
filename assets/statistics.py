...
class Statistics:
    ...
    def __get_displacement_from_itself_x(self, name):
    ...
    def __get_displacement_from_itself_y(self, name):
    ...
    def __get_displacement_from_itself_mag(self, name):
    ...
    def __get_displacement_from_center_object_x(self, name):
    ...
    def __get_displacement_from_center_object_y(self, name):
    ...
    def __get_displacement_from_center_object_mag(self, name):
    ...
    def __velocity(self, name, direction):
        match direction:
            case 0:
    ...
    def __acceleration(self, name, direction):
        match direction:
            case 0:
    ...
    def __force(self, name, direction):
        match direction:
            case 0:
    ...
    def __displacement_from_itself(self, name, direction):
        match direction:
            case 0:
    ...
    def __displacement_from_center(self, name, direction):
        match direction:
            case 0:
    ...
    def __displacement_from_center_object(self, name, direction):
        match direction:
            case 0:
    ...
    def general(self, name, data_choice, direction, displacement_mode):
        t = self.__get_t(name)
        self.__ax.clear()
    ...
    def energy(self, name, energy_choice, G):
        mass = self.__db[name].mass
        t = self.__get_t(name)
        self.__ax.clear()
